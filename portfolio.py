...
with tab_projects:
    ...
    # Embed Video Explanation (replace URL with your actual YouTube link if available)
    st.video("https://www.youtube.com/watch?v=example_video_id")  # Replace with your introduction video URL
